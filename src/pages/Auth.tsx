  ...
  return (
    <div className="min-h-screen gradient-celestial flex items-center justify-center px-6 overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute bottom-1/4 right-1/4 w-48 h-48 rounded-full bg-secondary/15 blur-3xl animate-float" style={{ animationDelay: "2s" }} />
      </div>
      ...
      >
        <div className="text-center mb-8">
          ...
          <h1 className="font-display text-3xl font-bold text-foreground mb-2">Welcome to AuraMatch</h1>
        ...
        <div className="p-6 rounded-2xl bg-card/80 backdrop-blur-sm border border-border/50">
          <Button
            ...
            variant="outline"
            className="w-full py-6 rounded-xl text-base font-medium border-border hover:bg-muted/50 transition-colors"
          >
